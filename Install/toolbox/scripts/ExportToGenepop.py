...
def main(input_features=None, where_clause=None, order_by=None,  output_name=None, 
       ...
       # Create and open the Output text file to which the data will be written
        output_name = open(output_name + ".txt", "w")
        ...
        output_name.write("Locus3\n")
        output_name.write("Locus4\n")
        output_name.write("Locus5\n")
        output_name.write("Locus6\n")
        output_name.write("Locus7\n")
        output_name.write("Locus8\n")
        output_name.write("Locus9\n")
        output_name.write("Locus10\n")
        output_name.write("Locus11\n")
        output_name.write("Locus12\n")
        output_name.write("Locus13\n")
        output_name.write("Locus14\n")  
