...
def writeToSRGD(fc, output_path):
    """ write out a Shepherd-compliant SRGD (CSV) file. """
    with open(output_path, 'w') as output_file:
        writer = csv.writer(output_file, dialect='excel', quotechar='"', quoting=csv.QUOTE_ALL)
        # fields generated by ArcGIS & lacking a direct use in Shepherd at this time
            ...
            for row in cursor:
                ...
                if date_exists:
                    ...
                    try:
                        ...
                        arcpy.AddError(e)
                    writer.writerow([xstr(r) for r in formatted_row])
